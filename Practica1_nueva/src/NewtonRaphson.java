 ...
 * @version 1.0
 * Entrada: Lee la aproximación inicial y el numero de iteraciones introducidos por el usuario
 * Salida: Según la aproximación inicial introducida por el usuario, imprime el resultado.
*/
